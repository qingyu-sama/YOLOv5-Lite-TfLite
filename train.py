...
def train(hyp, opt, device, tb_writer=None):
    ...
    if rank in [-1, 0]:
        ...
        run_id = torch.load(weights, weights_only=False).get(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='weights/v5Lite-s.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str,
                        default='models/v5Lite-s.yaml', help='model.yaml path')
